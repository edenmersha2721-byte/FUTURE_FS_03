...
export default function AboutSection() {
  return (
    <section id="about" className="flex min-h-screen flex-col justify-center bg-charcoal py-24">
      <div className="container-lux grid items-center gap-14 lg:grid-cols-2">
        <Reveal>
          <div className="relative">
            <img
              ...
              alt="Amra Beauty interior"
              className="rounded-3xl border border-line object-cover shadow-soft"
            />
        ...
        <Reveal delay={0.15}>
          ...
          <p className="mt-6 leading-relaxed text-muted">
            Amra Beauty was founded with a simple mission — to provide premium beauty and wellness services
          ...
          <p className="mt-6 font-script text-2xl text-gold-light">Because you deserve to feel beautiful.</p>
        </Reveal>
      </div>

      {/* Stats bar */}
      <div className="container-lux mt-16">
        <div className="grid grid-cols-2 gap-6 rounded-3xl border border-line bg-panel p-8 md:grid-cols-4">
          {stats.map((s, i) => (
            <motion.div
              key={s.label}
            ...
            >
              ...
              <p className="gold-text font-serif text-3xl font-bold md:text-4xl">{s.value}</p>
